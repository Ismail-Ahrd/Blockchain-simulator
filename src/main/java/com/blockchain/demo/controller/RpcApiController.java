...
public class RpcApiController {
    ...
    public ResponseEntity<Map<String,String>> receiveNAM(@PathVariable String publicKey) throws SignatureException {
    ...
    public ResponseEntity<Map<String,String>> addTransaction(@RequestBody Transaction transaction) throws SignatureException {
        Map<String,String> map = new HashMap<>();
    ...
    @PostMapping("/test")
    public boolean test(@RequestBody Test p) throws SignatureException {
